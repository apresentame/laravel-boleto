...
use Eduardokum\LaravelBoleto\Contracts\Pagamento\PagamentoAPI as PagamentoAPIContract;

class Inter extends AbstractPagamento implements PagamentoAPIContract
{
     ...
     * @throws ValidationException
     */
    public static function fromAPI($pagamento, $appends)
    {
        ...
        $aSituacao = [
            'PAGO'     => AbstractPagamento::SITUACAO_PAGO,
            'BAIXADO'  => AbstractPagamento::SITUACAO_BAIXADO,
            'VENCIDO'  => AbstractPagamento::SITUACAO_ABERTO,
            'EXPIRADO' => AbstractPagamento::SITUACAO_BAIXADO,
        ];
